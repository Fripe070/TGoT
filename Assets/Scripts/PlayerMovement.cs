...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Invisible boundaries for the X axis (left/right), as well as a safety net at the bottom
        ...
        else if (transform.position.y < -40) {transform.position = new Vector3(10f, 8f, 100f); }
